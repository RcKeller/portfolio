  ...
  render() {
    ...
    return (
      <LayoutWrapper>
        ...
        <InfoBar pages={data.pages.edges} parts={data.parts.edges} categories={this.categories} />
        {this.props.isWideScreen && <InfoBox pages={data.pages.edges} parts={data.parts.edges} categories={this.categories} />}
      </LayoutWrapper>
    );
  }
}
