...
const Nav = () => {
  ...
  // 
  const [pageName, setPageName] = useState('Andy Keller');
    ...
    <nav className={`nav ${value ? 'open' : ''}`}>
      <div className="nav-inner-box left">
        <div className="button-box">
          ...
          >
            <SidebarIcon />
            <Tooltip
              text={`${value ? 'Close' : 'Open'} folder view`}
              class="folder-tip left-point"
            />
          </button>
        </div>
      </div>
      <div className="nav-inner-box center">
        <div className="nav-link-box">
          <AnchorLink offset="140" href={anchorNav}>
            <h6 className="nav-anchor">{pageName}</h6>
          </AnchorLink>
          <Link href="/">
            <h6 className="nav-link">{homeName}</h6>
          </Link>
        </div>
      </div>
      <div className="nav-inner-box right">
        <div className="button-box">
          ...
          >
            ...
            <Tooltip
              text={`${
                lightMode ? 'Enter dark mode' : 'Enter light mode'
              }`}
              class="light-mode-tip right-point"
            />
          </button>
        </div>
